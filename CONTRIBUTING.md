# Contributing to workbench-devtools

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add devtools`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-devtools.git
cd workbench-devtools
...
wb dev devtools
# — or directly:
wb track devtools --branch <your-branch>
```
